...
public class UtilRest {
    ...
    * a transação realizada (inclusão, consulta, edição ou exclusão) caso ela seja realizada com sucesso
    * Repare que o método em questão aguarda que seja repassado um contexto que será
    * referenciado por um objeto chamado result.*/
    ...
    /*
    * Abaixo o método responsavel por enviar a resposta ao cliente sobre a transação realizada,
    * inclusão, consulta, edição ou exclusão. não realizadas com sucesso, ou seja, que tenha
    * algum erro.
    * Repare que o método em questão aguarda que seja repassado  um conteudo
    * que será referenciado por um objeto chamado rb.
    */
